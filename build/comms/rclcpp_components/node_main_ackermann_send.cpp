...
#define NODE_MAIN_LOGGER_NAME "ackermann_send"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcomms.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<comms::AckermannSend>";
