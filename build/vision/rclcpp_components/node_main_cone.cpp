...
#define NODE_MAIN_LOGGER_NAME "cone"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvision.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<vision::ConeDetectionNode>";
